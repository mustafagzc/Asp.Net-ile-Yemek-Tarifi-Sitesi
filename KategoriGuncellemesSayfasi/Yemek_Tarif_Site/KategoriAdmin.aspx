...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" Runat="Server">
    ...
    <asp:Panel ID="Panel2" runat="server">
        <asp:DataList ID="DataList1" runat="server" Width="451px" OnSelectedIndexChanged="DataList1_SelectedIndexChanged">
            <ItemTemplate>
                <table class="auto-style21">
                    <tr>
                        ...
                        <td class="auto-style23"> 
                            &nbsp;<a href="KategoriAdminGuncelle.aspx?Kategoriid=<%#Eval("Kategoriid") %>"><asp:Image ID="Image1" runat="server" Height="50px" ImageUrl="~/images/update.png" /></a>
                        </td>
                    </tr>
                </table>
            </ItemTemplate>
            ...
            <table class="auto-style21">
                ...
                <tr>
                    <td class="auto-style15" colspan="2">
                        <asp:Button ID="Button6" runat="server" Text="Ekle" OnClick="Button6_Click" Width="143px" />
                    </td>
                </tr>
            </table>
